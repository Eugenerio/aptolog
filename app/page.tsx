      ...
      <div className="overflow-x-hidden">
        <section className="flex items-center justify-center mt-14">
          <div className="text-center">
            <h1 className="font-sf-pixelate text-white px-[500px] text-4xl uppercase mb-12 mt-20">
              Create the extraordinary - bring your dreams to life!
            </h1>
            <button
        ...
        <section className="bg-grey text-white text-center py-10 mt-14">
        ...
        <section className="flex items-center justify-center text-white mt-14">
          <div className="text-center">
            ...
            <div className="max-w-[780px] mx-5 text-2xl">
              <div className="self-stretch relative font-roboto text-[inherit]">
                <p className="mb-4">
                  ...
                  that benefits the entire world through easier development,
                  more reliable services, faster transactions, and a supportive,
        ...
        <section className="flex flex-col md:flex-row justify-center gap-8 mt-14">
          <Card
            title="SCALIABILITY"
        ...
        <section className="flex items-center justify-center text-white pt-14">
          <div className="text-center">
        ...
        <section className="flex justify-center items-center pt-14 pb-14">
